...
void USART1_IRQHandler(void)
{
  if(USART_GetITStatus(USART1, USART_IT_RXNE))//enter interrupt when STM32 receive data.
  {
	...
	case TRACER_CMD_SEND_RAW:
	{
		...
		USART_Send(USART1,RAW_VAL_FLAG);
		USART_Send(USART1,Tracer_front_H);
		USART_Send(USART1,Tracer_front_L);
		USART_Send(USART1,Tracer_back_H);
		USART_Send(USART1,Tracer_back_L);
		USART_Send(USART1,Tracer_Stat[FINAL]);
	...
	case TRACER_CMD_SEND_RGB:
	{
		...
		USART_Send(USART1,COMMAND_FLAG_A);
		USART_Send(USART1,COMMAND_FLAG_B);
		USART_Send(USART1,RGB_VAL_FLAG);
		USART_Send(USART1,Tracer_front_R_H);
		USART_Send(USART1,Tracer_front_R_L);
		USART_Send(USART1,Tracer_front_G_H);
		USART_Send(USART1,Tracer_front_G_L);
		USART_Send(USART1,Tracer_front_B_H);
		USART_Send(USART1,Tracer_front_B_L);
		USART_Send(USART1,Tracer_Stat[FINAL]);
	...
	case HYBRID_CMD_SEND_THRESHOLD:
	{
		...
		USART_Send(USART1,COMMAND_FLAG_A);
		USART_Send(USART1,COMMAND_FLAG_B);
		USART_Send(USART1,TH_DATA);
		USART_Send(USART1,TH_UP_H);
		USART_Send(USART1,TH_UP_L);
		USART_Send(USART1,TH_LOWER_H);
		USART_Send(USART1,TH_LOWER_L);
		USART_Send(USART1,TH_RGB_FRONT_UP_H);
		USART_Send(USART1,TH_RGB_FRONT_UP_L);
		USART_Send(USART1,TH_RGB_FRONT_LOW_H);
		USART_Send(USART1,TH_RGB_FRONT_LOW_L);
		USART_Send(USART1,TH_RGB_BACK_UP_H);
		USART_Send(USART1,TH_RGB_BACK_UP_L);
		USART_Send(USART1,TH_RGB_BACK_LOW_H);
		USART_Send(USART1,TH_RGB_BACK_LOW_L);
	}break;
	}
